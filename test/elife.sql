...
(
	...
	parmanent_resident smallint not null,
	user_id varchar(50)
);
...
(
	...
	user_identity_number varchar(20) not null, 
...
(
	...
	notice_user_id varchar(50) not null,
...
(
	report_repair_id int primary key auto_increment, 
	report_user_id varchar(50) not null,
	report_problem varchar(100) not null, 
	report_datetime datetime not null, 
	report_state varchar(100) not null default('待处理'),
	repair_finish_datetime datetime, 
...
(
	...
	household_id int not null, 
	remain_type varchar(20) not null, 
	remain_amount numeric(10,2) not null, 
...
(
	...
	payment_send_date datetime not null, 
	payment_deadline datetime not null,
	payment_amount decimal(10,2) not null, 
	household_id int not null, 
	payment_type varchar(20) not null, 
	payment_state int not null default(0), 
	payment_finish_time datetime, 
...
(
	...
	parking_place_description varchar(50) not null, 
	parking_car_number varchar(20) default('none') 
);
...
(  
	shopping_order_id int primary key auto_increment, 
...
(
	express_address_id int primary key auto_increment, 
	express_user_id varchar(50) not null, 
	express_address_type int not null,
	express_name varchar(20) not null, 
	express_phone_number varchar(20) not null, 
	express_province varchar(20) not null, 
	express_city varchar(20) not null, 
	express_district varchar(20) not null, 
	express_postal_code varchar(20) not null,
	express_detailed_address text not null, 
...
(
	...
	logistic_order_id varchar(100) not null default('loaded'), 
	logistic_submit_date datetime not null, 
	user_id varchar(50) not null, 
	sender_name varchar(20) not null, 
	logistic_type int not null, 
	sender_phone_number varchar(20) not null, 
	sender_province varchar(20) not null, 
	sender_city varchar(20) not null, 
	sender_district varchar(20) not null, 
	sender_postal_code varchar(20) not null, 
	sender_detailed_address text not null, 	
	...
	receiver_detailed_address text not null, 
	logistic_money numeric(10,2) not null, 
	courier_id int, 
	logistic_last_state varchar(100) default('待处理'), 
	logistic_last_updatetime datetime, 
	logistic_finish smallint not null default 0,
...
(
	logistic_state_id int primary key auto_increment, 
	logistic_id int not null, 
	logistic_state_time datetime not null, 
	logistic_state_description varchar(100) not null, 
...
begin 
	...
	set addstr = concat('L',concat((select date_format(now(),'%Y-%m-%d_%H:%i:%S')),lidstr));
...
insert into announcement(announcement_content,announcement_date) values('春节前夕，大家防疫工作仍然不能懈怠。请每户派一个代表来物业中心领取各家的免费口罩',now());
...
insert into product_category values(null,'时令蔬菜');
insert into product_category values(null,'新鲜水果'); 
insert into product_category values(null,'酒水乳品'); 
insert into product_category values(null,'日用百货'); 
insert into product_category values(null,'优惠活动'); 
insert into product_category values(null,'其它类型');
...
insert into express_item_category values(null,'文件票证'); 
insert into express_item_category values(null,'数码产品'); 
insert into express_item_category values(null,'日用品'); 
insert into express_item_category values(null,'生鲜水果'); 
insert into express_item_category values(null,'休闲食品');
insert into express_item_category values(null,'服装鞋帽'); 
insert into express_item_category values(null,'工艺品'); 
insert into express_item_category values(null,'珠宝首饰'); 
insert into express_item_category values(null,'其它'); 
